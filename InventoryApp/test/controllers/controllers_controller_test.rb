...
class ControllersControllerTest < ActionController::TestCase
  ...
  test "should create controller" do
    assert_difference('Controller.count') do
      post :create, controller: { InventoryItemTypeCategories: @controller.InventoryItemTypeCategories, ItemTypeCategory: @controller.ItemTypeCategory }
    end
  ...
  test "should update controller" do
    patch :update, id: @controller, controller: { InventoryItemTypeCategories: @controller.InventoryItemTypeCategories, ItemTypeCategory: @controller.ItemTypeCategory }
    assert_redirected_to controller_path(assigns(:controller))
  end
